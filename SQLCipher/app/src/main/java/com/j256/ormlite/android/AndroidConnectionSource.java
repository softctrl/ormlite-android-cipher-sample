...
public class AndroidConnectionSource extends BaseConnectionSource implements ConnectionSource {
	...
	// Well, better if you change this value in your project :D
	public static final char[] DEFAULT_PASSWORD = "6c8904237d06c6091971e53122bae4e6".toCharArray();
	...
	public DatabaseConnection getReadWriteConnection() throws SQLException {
		return getReadWriteConnection(AndroidConnectionSource.DEFAULT_PASSWORD);
	}

	public DatabaseConnection getReadWriteConnection(final char[] password) throws SQLException {
